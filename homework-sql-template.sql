...
WHERE BirthDate > DATEFROMPARTS(1989, 09, 28)
GO
...
SELECT *
FROM Person.Person
WHERE (YEAR(ModifiedDate) = 2008) AND 
...
-------------------------------------------------------------
SELECT DISTINCT Name, EndDate
FROM HumanResources.Department LEFT JOIN HumanResources.EmployeeDepartmentHistory ON 
...
-------------------------------------------------------------
SELECT TerritoryID, SUM(CommissionPct) as SumCommision
